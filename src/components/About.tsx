...
const About = () => {
  const valueProps = [
    ...
    },
    {
      ...
      title: "Team Player",
      description:
        "I collaborate effectively, communicate clearly, and share knowledge with my peers.",
    },
    {
      icon: <Lightbulb className="h-8 w-8 text-blue-500" />,
      title: "Innovative",
      description:
        "I stay current with emerging technologies and bring creative ideas to the table.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
            ...
            building web applications. I specialize in front-end development
            using React, TypeScript, Redux and modern CSS frameworks. My
            background in computer science gives me a strong foundation in
            algorithms and data structures.
          </p>
          <p className="text-lg text-gray-700 dark:text-gray-300">
            When I'm not coding, you can find me playing and watching cricket,
            or experimenting with new cooking recipes. I believe in continuous
            learning and constantly push myself to explore new technologies and
            approaches.
          </p>
        </div>
